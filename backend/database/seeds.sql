...
('Admin User', 'admin@dinendash.com', '$2a$10$vUAA5SEp4EUeM3TAG4dcfuxebDuNbKdBsgxRJUCnKnzcWEOmQ1pX.', '9876543210', 'admin', TRUE),
('John Doe', 'john@example.com', '$$2a$10$umjb3Fpw3WZU/WKCHnhJXOHwWCXQW93ySoxDZfGGuDtYPpQKb3Lwu', '9876543211', 'customer', TRUE),
('Jane Smith', 'jane@example.com', '$$2a$10$LkOjFUQWITGttOyyg/GfQerZKMKRYYBVj5lAZ0xHBH5W97JGW05yC', '9876543212', 'customer', TRUE),
('Mike Johnson', 'mike@example.com', '$2a$10$cj9UTQItbC4gK73/CrLgYOKxgAn/Oxk1jSqyS4JiyrIB2nc336P6K', '9876543213', 'customer', TRUE),
('Sarah Williams', 'sarah@example.com', '$2a$10$pHK3lW9sYv3vl0G0/q1deORGguRqihNIEre41GzXFej7wQz.P1mOm', '9876543214', 'customer', TRUE);
